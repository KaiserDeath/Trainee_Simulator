# Evaluator key — Operator Technical Test, Form D

**Internal document. Do not hand to the candidate.**

Generated with: `node scripts/generate-operator-technical-test.mjs D`

## Section 1 — key

| # | Requested | Correct answer | Near twins in the registry |
| ---: | --- | --- | --- |
| 1 | `ACC-3K7V-2289` | NOT PRESENT | `ACC-3K7V-2298` (2) |
| 2 | `ACC-9C1T-3047` | 4 | `ACC-9C1T-3O47` (1) |
| 3 | `ACC-8G4W-7T12` | 3 | `ACC-8G4W-7712` (1) |
| 4 | `ACC-4F8K-2O93` | 14 | `ACC-4F8K-2093` (1) |
| 5 | `ACC-1L9O-6304` | NOT PRESENT | `ACC-1L9Q-6304` (1), `ACC-1I9Q-6304` (2) |
| 6 | `ACC-2H6R-8812` | 9 | `ACC-2H6R-8821` (2) |
| 7 | `ACC-5S3D-4461` | NOT PRESENT | `ACC-5S3D-4460` (1), `ACC-5S3D-4462` (1) |
| 8 | `ACC-6Z0N-5583` | 5 | `ACC-6Z0N-5S83` (1) |

## Section 2 — key

| # | Customer | Balance | Held | Requested | Available | Decision | Note |
| ---: | --- | ---: | ---: | ---: | ---: | --- | --- |
| 1 | C-4702 | 740 | 240 | 500 | **500** | **PROCEED** | boundary — exactly Available |
| 2 | C-2041 | 900 | 350 | 600 | **550** | **REJECT** | trap — fits Balance, not Available |
| 3 | C-9127 | 1000 | 250 | 700 | **750** | **PROCEED** | clearly payable |
...
| 6 | C-6890 | 300 | 75 | 180 | **225** | **PROCEED** | clearly payable |
...
| B | **5** | Perform the credit on the game platform. |
| C | **3** | Find the game account by its exact identifier. |
| D | **4** | Check Available funds (Balance minus Held) against the requested amount. |
| E | **2** | Confirm the customer on the request matches the customer on record. |
| F | **6** | Confirm the game platform recorded the credit. |
| G | **7** | Enter the Backend decision once. |
...
| Case | Rule | Why |
| ---: | --- | --- |
| 1 | **R6** | If the evidence is missing, unreadable or contradictory, stop and escalate. |
