# Prueba de Aptitud Operativa — Forma E
...
| --- | --- | ---: | ---: | ---: | ---: |
| TX001 | JUG243 | 25 | 200 | 195 | 20 |
| TX002 | JUG297 | 70 | 85 | 15 | 0 |
| TX003 | JUG897 | 50 | 100 | 60 | 10 |
| TX004 | JUG243 | 50 | 200 | 170 | 20 |

**Tabla 2**

| ID Transacción | ID Jugador | Créditos Apostados | Créditos Ganados | Pago Procesado | Bono Aplicado |
| --- | --- | ---: | ---: | ---: | ---: |
| TX005 | JUG575 | 55 | 190 | 164 | 19 |
| TX006 | JUG243 | 100 | 65 | -35 | 0 |
| TX007 | JUG575 | 30 | 120 | 102 | 12 |
| TX008 | JUG806 | 15 | 130 | 128 | 13 |

**Tabla 3**

| ID Transacción | ID Jugador | Créditos Apostados | Créditos Ganados | Pago Procesado | Bono Aplicado |
| --- | --- | ---: | ---: | ---: | ---: |
| TX009 | JUG806 | 85 | 75 | -10 | 0 |
| TX010 | JUG521 | 45 | 170 | 142 | 17 |
| TX011 | JUG758 | 70 | 250 | 205 | 25 |
| TX012 | JUG758 | 60 | 180 | 138 | 18 |

**Tabla 4**

| ID Transacción | ID Jugador | Créditos Apostados | Créditos Ganados | Pago Procesado | Bono Aplicado |
| --- | --- | ---: | ---: | ---: | ---: |
| TX013 | JUG806 | 20 | 140 | 134 | 14 |
| TX014 | JUG758 | 15 | 170 | 155 | 0 |
| TX015 | JUG297 | 60 | 80 | 28 | 8 |
| TX016 | JUG758 | 100 | 200 | 120 | 20 |

**Tabla 5**

| ID Transacción | ID Jugador | Créditos Apostados | Créditos Ganados | Pago Procesado | Bono Aplicado |
| --- | --- | ---: | ---: | ---: | ---: |
| TX017 | JUG897 | 30 | 90 | 60 | 0 |
| TX018 | JUG897 | 45 | 80 | 35 | 0 |
| TX019 | JUG897 | 80 | 150 | 70 | 0 |
| TX020 | JUG758 | 25 | 110 | 96 | 11 |

**Tabla 6**

| ID Transacción | ID Jugador | Créditos Apostados | Créditos Ganados | Pago Procesado | Bono Aplicado |
| --- | --- | ---: | ---: | ---: | ---: |
| TX021 | JUG243 | 25 | 160 | 145 | 10 |
| TX022 | JUG521 | 50 | 95 | 45 | 0 |
| TX023 | JUG297 | 65 | 220 | 176 | 22 |
| TX024 | JUG521 | 40 | 70 | 30 | 0 |
...
**Caso 1.** La solicitud pide retirar 500 créditos de USR-9C1T-3047. El saldo visible en la plataforma para esa cuenta es de 320 créditos. La identidad está verificada.

**Caso 2.** Llega una solicitud de carga de 120 créditos para USR-7B2M-1150. El historial muestra una carga de 120 créditos para ese mismo jugador registrada hace 3 minutos, con el mismo número de comprobante.
...
**Caso 5.** La solicitud pide retirar 45 créditos de USR-1L9Q-6304. La cuenta coincide, la identidad está verificada, el saldo es de 610 créditos y no hay retiros previos hoy para ese jugador.

**Caso 6.** La solicitud escrita pide cargar 200 créditos a USR-8G4W-7712. El comprobante adjunto, legible, muestra 2000. La cuenta y la identidad coinciden.
