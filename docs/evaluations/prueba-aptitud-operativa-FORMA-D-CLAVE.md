# Clave y rúbrica — Prueba de Aptitud Operativa, Forma D

**Documento interno. No entregar al candidato.**

Generado con: `node scripts/generate-operations-aptitude-test.mjs D`

## Sección A — clave

| ID | Apostados | Ganados | Bono correcto | Pago Esperado | Pago Procesado | Veredicto | Causa |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| TX001 (T1) | 85 | 75 | 0 | -10 | -10 | OK | — |
| TX002 (T1) | 25 | 200 | 20 | 195 | 195 | OK | — |
| TX003 (T1) | 65 | 220 | 22 | 177 | 176 | **ERROR** | C4 |
| TX004 (T1) | 50 | 100 | 10 | 60 | 60 | OK | — |
| TX005 (T2) | 45 | 170 | 17 | 142 | 142 | OK | — |
| TX006 (T2) | 70 | 250 | 25 | 205 | 205 | OK | — |
| TX007 (T2) | 100 | 65 | 0 | -35 | -35 | OK | — |
| TX008 (T2) | 55 | 190 | 19 | 154 | 164 | **ERROR** | C4 |
| TX009 (T3) | 20 | 140 | 14 | 134 | 134 | OK | — |
| TX010 (T3) | 40 | 70 | 0 | 30 | 30 | OK | — |
| TX011 (T3) | 60 | 180 | 18 | 138 | 138 | OK | — |
| TX012 (T3) | 25 | 110 | 11 | 96 | 96 | OK | — |
| TX013 (T4) | 100 | 200 | 20 | 120 | 120 | OK | — |
| TX014 (T4) | 15 | 130 | 13 | 128 | 128 | OK | — |
| TX015 (T4) | 70 | 85 | 0 | 15 | 15 | OK | — |
| TX016 (T4) | 30 | 120 | 12 | 102 | 102 | OK | — |
| TX017 (T5) | 50 | 200 | 20 | 170 | 170 | OK | — |
| TX018 (T5) | 25 | 160 | 16 | 151 | 145 | **ERROR** | C2 |
| TX019 (T5) | 15 | 170 | 17 | 172 | 155 | **ERROR** | C1 |
| TX020 (T5) | 30 | 90 | 0 | 60 | 60 | OK | — |
| TX021 (T6) | 60 | 80 | 0 | 20 | 28 | **ERROR** | C3 |
| TX022 (T6) | 50 | 95 | 0 | 45 | 45 | OK | — |
| TX023 (T6) | 45 | 80 | 0 | 35 | 35 | OK | — |
| TX024 (T6) | 80 | 150 | 15 | 85 | 70 | **ERROR** | C1 |
...
| ---: | --- | --- | --- |
| 1 | `USR-4F8K-2O93` | 1 | `USR-4F8K-2093` (1 carácter) |
| 2 | `USR-3K7V-2289` | NO EXISTE | `USR-3K7V-2298` (2 carácteres) |
| 3 | `USR-8G4W-7T12` | 11 | `USR-8G4W-7712` (1 carácter) |
| 4 | `USR-1L9O-6304` | NO EXISTE | `USR-1L9Q-6304` (1 carácter), `USR-1I9Q-6304` (2 carácteres) |
| 5 | `USR-2H6R-8812` | 15 | `USR-2H6R-8821` (2 carácteres) |
| 6 | `USR-5S3D-4461` | NO EXISTE | `USR-5S3D-4460` (1 carácter), `USR-5S3D-4462` (1 carácter) |
| 7 | `USR-6Z0N-5583` | 10 | `USR-6Z0N-5S83` (1 carácter) |
| 8 | `USR-9C1T-3047` | 13 | `USR-9C1T-3O47` (1 carácter) |
...
| 3 | RECHAZAR | M2 | no |
| 4 | RECHAZAR | M3 | no |
| 5 | DETENER Y ESCALAR | M4 | **sí** |
| 6 | DETENER Y ESCALAR | M4 | **sí** |
