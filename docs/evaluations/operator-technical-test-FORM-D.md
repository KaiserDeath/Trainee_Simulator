# Operator Technical Test — Form D
...
| ---: | --- | ---: | ---: | ---: |
| 1 | C-4702 | 740 | 240 | 500 |
| 2 | C-2041 | 900 | 350 | 600 |
| 3 | C-9127 | 1000 | 250 | 700 |
| 4 | C-7355 | 650 | 650 | 25 |
...
| B | Perform the credit on the game platform. |  |
| C | Find the game account by its exact identifier. |  |
| D | Check Available funds (Balance minus Held) against the requested amount. |  |
| E | Confirm the customer on the request matches the customer on record. |  |
| F | Confirm the game platform recorded the credit. |  |
| G | Enter the Backend decision once. |  |

### 4.2 Which rule was broken

For each case, write the code of the **first** rule the operator broke.

**Case 1.** The proof attached to the request is cut off and the amount cannot be read. The operator credited the amount typed in the request text and moved on.
...
**Request 1.** Request: withdraw 500 from ACC-9C1T-3047 for customer C-4702. Customer and account match. The game account balance is 320.

**Request 2.** Request: credit 90 to ACC-6Z0N-5583 for customer C-9127. No proof is attached and the Backend shows no record of funds received.
...
**Request 6.** Request: credit an amount to ACC-5S3D-4460 for customer C-7355. The attached proof is cut off: the customer name is visible but the amount cannot be read with certainty.
