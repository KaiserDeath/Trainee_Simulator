# Evaluator key — Operator Technical Test, Form B

**Internal document. Do not hand to the candidate.**

Generated with: `node scripts/generate-operator-technical-test.mjs B`

## Section 1 — key

| # | Requested | Correct answer | Near twins in the registry |
| ---: | --- | --- | --- |
| 1 | `ACC-1L9O-6304` | NOT PRESENT | `ACC-1L9Q-6304` (1), `ACC-1I9Q-6304` (2) |
| 2 | `ACC-6Z0N-5583` | 12 | `ACC-6Z0N-5S83` (1) |
| 3 | `ACC-8G4W-7T12` | 15 | `ACC-8G4W-7712` (1) |
| 4 | `ACC-3K7V-2289` | NOT PRESENT | `ACC-3K7V-2298` (2) |
| 5 | `ACC-9C1T-3047` | 1 | `ACC-9C1T-3O47` (1) |
| 6 | `ACC-2H6R-8812` | 4 | `ACC-2H6R-8821` (2) |
| 7 | `ACC-5S3D-4461` | NOT PRESENT | `ACC-5S3D-4460` (1), `ACC-5S3D-4462` (1) |
| 8 | `ACC-4F8K-2O93` | 7 | `ACC-4F8K-2093` (1) |
...
| 3 | C-2041 | 900 | 350 | 600 | **550** | **REJECT** | trap — fits Balance, not Available |
| 4 | C-5263 | 1200 | 800 | 450 | **400** | **REJECT** | trap — fits Balance, not Available |
| 5 | C-8014 | 480 | 130 | 350 | **350** | **PROCEED** | boundary — exactly Available |
| 6 | C-7355 | 650 | 650 | 25 | **0** | **REJECT** | trap — fits Balance, not Available |
...
| --- | ---: | --- |
| A | **2** | Confirm the customer on the request matches the customer on record. |
| B | **4** | Check Available funds (Balance minus Held) against the requested amount. |
...
| F | **6** | Confirm the game platform recorded the credit. |
| G | **3** | Find the game account by its exact identifier. |
...
| Case | Rule | Why |
| ---: | --- | --- |
| 1 | **R3** | Adding credits places a hold on the customer funds. |
...
| ---: | --- | --- | --- |
| 1 | STOP AND ESCALATE | M4 | **yes** |
| 2 | REJECT | M3 | no |
| 3 | APPROVE | M6 | no |
| 4 | APPROVE | M6 | no |
| 5 | REJECT | M3 | no |
| 6 | STOP AND ESCALATE | M4 | **yes** |
