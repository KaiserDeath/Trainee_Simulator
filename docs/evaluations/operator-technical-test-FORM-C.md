# Operator Technical Test — Form C
...
| ---: | --- | ---: | ---: | ---: |
| 1 | C-5263 | 1200 | 800 | 450 |
| 2 | C-9127 | 1000 | 250 | 700 |
| 3 | C-7355 | 650 | 650 | 25 |
| 4 | C-3118 | 500 | 0 | 480 |
| 5 | C-2041 | 900 | 350 | 600 |
...
| --- | --- | --- |
| A | Open the request and read the requested amount. |  |
| B | Enter the Backend decision once. |  |
| C | Check Available funds (Balance minus Held) against the requested amount. |  |
| D | Perform the credit on the game platform. |  |
| E | Find the game account by its exact identifier. |  |
| F | Confirm the customer on the request matches the customer on record. |  |
...
**Case 1.** The operator could not find ACC-5S3D-4462, saw ACC-5S3D-4460 in the list, decided it was close enough and credited that account.
...
**Request 1.** Request: credit 45 to ACC-1L9Q-6304 for customer C-8014. Account and customer match. Proof is legible and reads 45. Available funds are 610. The game history shows no earlier action for this reference.
...
**Request 3.** Request: credit 120 to ACC-7B2M-1150 for customer C-2041. The Backend history already shows an APPROVED decision of 120 for this same reference, entered four minutes ago, and the game history shows the matching credit.

**Request 4.** Request: credit 90 to ACC-6Z0N-5583 for customer C-9127. No proof is attached and the Backend shows no record of funds received.

**Request 5.** Request: credit an amount to ACC-5S3D-4460 for customer C-7355. The attached proof is cut off: the customer name is visible but the amount cannot be read with certainty.

**Request 6.** Request: credit 480 to ACC-3K7V-2298 for customer C-5263. Customer and account match and the proof is legible. The customer has a Balance of 1200 with 800 already held against pending operations.
